    ...
    <form class="layui-form  "  id="add-form"  action="" >
        <div class="layui-form-item center" >
            ...
            <div class="layui-input-block">
                <input type="text" id="xsbh" name="xsbh" required style="width: 240px"  lay-verify="required" placeholder="请输入学号" autocomplete="off" class="layui-input">
            </div>
        </div>
...
<script>
    ...
    layui.use('form', function(){
        ...
        form.on('submit(save)', function(data){
            ...
            $.post('/AddStudentServlet',data.field,function(data){
                if(data > 0){
                    // layer.close(loading);
                    //消息提示
