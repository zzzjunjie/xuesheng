    ...
    <form class="layui-form  "  id="add-form"  action="" >
        <div class="layui-form-item center" >
            ...
            <div class="layui-input-block">
                <input type="text" id="u_id" name="u_id" required style="width: 240px"  lay-verify="required" placeholder="请输入账号" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="password" id="u_password" name="u_password" required  style="width: 240px" lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    ...
    layui.use('form', function(){
        ...
        form.on('submit(save)', function(data){
            ...
            $.post('/AddAdminServlet',data.field,function(data){
                if(data > 0){
                    // layer.close(loading);
                    //消息提示
                    parent.layer.msg("添加成功^_^");
                    //关闭弹出层
